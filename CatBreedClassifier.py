...
class CatBreedClassifier:
    ...
    def train(self, num_epochs=25):
        ...
        torch.save(self.model, "D:/petcat/petcatty/petcatty/app/model1.pt")
...
if __name__ == "__main__":
    TRAIN_DIR = r"D:/petcat/petcatty/petcatty/35-cat-breed-dataset/train"
    TEST_DIR = r"D:/petcat/petcatty/petcatty/35-cat-breed-dataset/test"

    classifier = CatBreedClassifier(TRAIN_DIR, TEST_DIR)
    classifier.train(num_epochs=25)
    classifier.evaluate()